...
public final class CoreCharacter implements Character {
    ...
    private CoreCharacter(CharacterBuilder builder, int save, Connection conn) {
    ...
    public static class CharacterBuilder {
    	...
    	public Character buildAndSave(Connection conn) {
    		return new CoreCharacter(this, 1, conn);
    	}
    	
    	public Character build() {
    		return new CoreCharacter(this, 0, null);
    	}
    	
    	public Character buildAndUpdate(Connection conn) {
    		return new CoreCharacter(this, 2, conn);
    	}
    }
